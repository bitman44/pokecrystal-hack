...
BASE_EFFORT      EQUS "(wBaseEffort - wCurBaseData)"
...
MON_EFFORT_EXP         EQUS "(wPartyMon1EffortExp - wPartyMon1)"
...
; MON_SPC_EXP            EQUS "(wPartyMon1SpcExp - wPartyMon1)"	; to remove
MON_DVS                EQUS "(wPartyMon1DVs - wPartyMon1)"	; to remove
MON_SATK_EXP            EQUS "(wPartyMon1SAtkExp - wPartyMon1)"
MON_SDEF_EXP            EQUS "(wPartyMon1SDefExp - wPartyMon1)"
MON_IVS                EQUS "(wPartyMon1IVs - wPartyMon1)"
; MON_PV                 EQUS "(wPartyMon1PV - wPartyMon1)"
